    ...
    return(
        <>
            <section className='bg-white flex justify-between items-center max-h-13'>
                ...
                <nav className='justify-center flex sm:gap-2 sm:mx-5 mx-1 items-center'>
                    ...
                    {user ? (user.role === 'admin' ? (
                        ...
                        <>
                            <div className='flex items-center border-gray-300 border-l pl-4 sm:gap-3 gap-1'>
                        ...
                        <>
                            <div className='flex items-center border-gray-300 border-l sm:pl-2 pl-1 pr-1 gap-2'>
