                    ...
                    <div className='bg-white mt-15 w-120 py-5'>
                        ...
                        <div className='flex justify-center'>
                            <form action="" className='w-80'>
                                ...
                                <input required className='border-gray-400 border-1 rounded-md p-2 w-full' type="text" onChange={(e)=>setForm({...registerForm, username : e.target.value})}/>
                                <h1 className='py-2'>Email</h1>
                                <input className='required border-gray-400 border-1 rounded-md p-2 w-full' type="text" onChange={(e)=>setForm({...registerForm, email : e.target.value})}/>
                                <h1 className='py-2'>Password</h1>
                                <div className='flex'>
                                    <input className='required border-gray-400 border-1 rounded-md p-2 w-full' type={showPassword ? "text" : "password"} onChange={(e)=>setForm({...registerForm, password : e.target.value})}/>
                                ...
                                <div className='flex'>
                                    <input className='required border-gray-400 border-1 rounded-md p-2 w-full' type={showCheckPassword ? "text" : "password"} onChange={(e)=>setForm({...registerForm, confirmPassword : e.target.value})} />
                                ...
                                <div className="flex justify-center pt-5">
                                    <button onClick={registerHandle} type="button" className="bg-green-600 text-white w-full rounded-md py-2 hover:cursor-pointer">Confirm</button>
                                </div>
